...
public class BooksController {
    ...
    public ResponseEntity<Void> updateBook(@RequestBody Book book) {
        if (booksService.find(book.getId()) != null) {
            ...
            Book originalBook = booksService.find(book.getId());
            if (book.getTitle() == null) {
                book.setTitle(originalBook.getTitle());
            }
            if (book.getAmount() == null) {
                book.setAmount(originalBook.getAmount());
            }
            if (book.getAuthor() == null) {
                book.setAuthor(originalBook.getAuthor());
            }
            if (book.getNumberOfPages() == null) {
                book.setNumberOfPages(originalBook.getNumberOfPages());
            }
            if (book.getPublisher() == null) {
                book.setPublisher(originalBook.getPublisher());
            }
            if (book.getPrice() == null) {
                book.setPrice(originalBook.getPrice());
            }
